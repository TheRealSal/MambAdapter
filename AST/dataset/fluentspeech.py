...
class FluentSpeech(Dataset):
    ...
    def __init__(self, data_path, max_len_AST, train: Union[bool, str] = True, apply_SpecAug=False, few_shot=False,
                 samples_per_class=1, cache_dir=''):
    ...
    def get_data(self):
        processor = AutoFeatureExtractor.from_pretrained("MIT/ast-finetuned-audioset-10-10-0.4593",
                                                         max_length=self.max_len_AST, cache_dir=self.cache_dir)
